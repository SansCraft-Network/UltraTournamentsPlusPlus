...
/**
 * Command handler for UTP kit management (/utpkit)
 */
public class UtpKitCommand implements CommandExecutor, TabCompleter {
    
    private final UltraTournamentsPlusPlus plugin;
    
    public UtpKitCommand(UltraTournamentsPlusPlus plugin) {
        this.plugin = plugin;
    }
    ...
    private boolean handleCreate(CommandSender sender, String[] args) {
        if (args.length < 2) {
            MessageUtils.sendError(sender, "Usage: /utpkit create <name>");
            return true;
        }
        ...
        MessageUtils.sendInfo(sender, "Use /utpkit save " + name + " while holding items to populate it");
    ...
    private boolean handleDelete(CommandSender sender, String[] args) {
        if (args.length < 2) {
            MessageUtils.sendError(sender, "Usage: /utpkit delete <name>");
            return true;
        }
    ...
    private boolean handleInfo(CommandSender sender, String[] args) {
        if (args.length < 2) {
            MessageUtils.sendError(sender, "Usage: /utpkit info <name>");
            return true;
        }
    ...
    private boolean handleApply(CommandSender sender, String[] args) {
        if (args.length < 2) {
            MessageUtils.sendError(sender, "Usage: /utpkit apply <name> [player]");
            return true;
        }
    ...
    private boolean handleSave(CommandSender sender, String[] args) {
        ...
        if (args.length < 2) {
            MessageUtils.sendError(sender, "Usage: /utpkit save <name>");
            return true;
        }
    ...
    private boolean handleClone(CommandSender sender, String[] args) {
        if (args.length < 3) {
            MessageUtils.sendError(sender, "Usage: /utpkit clone <original> <new_name>");
            return true;
        }
    ...
    private boolean handleEdit(CommandSender sender, String[] args) {
        if (args.length < 3) {
            MessageUtils.sendError(sender, "Usage: /utpkit edit <name> <setting> <value>");
        ...
        switch (setting) {
            case "description":
                if (args.length < 4) {
                    MessageUtils.sendError(sender, "Usage: /utpkit edit " + kitName + " description <text>");
                    return true;
                }
            ...
            case "clearinv":
                if (args.length < 4) {
                    MessageUtils.sendError(sender, "Usage: /utpkit edit " + kitName + " clearinv <true/false>");
                    return true;
                }
            ...
            case "resethealth":
                if (args.length < 4) {
                    MessageUtils.sendError(sender, "Usage: /utpkit edit " + kitName + " resethealth <true/false>");
                    return true;
                }
            ...
            case "resethunger":
                if (args.length < 4) {
                    MessageUtils.sendError(sender, "Usage: /utpkit edit " + kitName + " resethunger <true/false>");
                    return true;
                }
            ...
            case "resetxp":
                if (args.length < 4) {
                    MessageUtils.sendError(sender, "Usage: /utpkit edit " + kitName + " resetxp <true/false>");
                    return true;
                }
            ...
            case "xplevel":
                if (args.length < 4) {
                    MessageUtils.sendError(sender, "Usage: /utpkit edit " + kitName + " xplevel <number>");
                    return true;
                }
                try {
    ...
    private void sendHelp(CommandSender sender) {
        MessageUtils.sendMessage(sender, "§6§lUTP Kit Commands:");
        MessageUtils.sendMessage(sender, "§e/utpkit create <name> §7- Create new empty kit");
        MessageUtils.sendMessage(sender, "§e/utpkit delete <name> §7- Delete kit");
        MessageUtils.sendMessage(sender, "§e/utpkit list §7- List all kits");
        MessageUtils.sendMessage(sender, "§e/utpkit info <name> §7- Show kit information");
        MessageUtils.sendMessage(sender, "§e/utpkit apply <name> [player] §7- Apply kit to player");
        MessageUtils.sendMessage(sender, "§e/utpkit save <name> §7- Save current inventory as kit");
        MessageUtils.sendMessage(sender, "§e/utpkit clone <original> <new> §7- Clone existing kit");
        MessageUtils.sendMessage(sender, "§e/utpkit edit <name> <setting> <value> §7- Edit kit settings");
    }
